...
from direct.gui.OnscreenImage import OnscreenImage  # Імпорт класу для роботи з зображеннями на екрані
from panda3d.core import BitMask32  # Імпорт класу для бітових ма
key_switch_camera = 'c' 
...
class Hero():
    ...
    def cameraBind(self):
        ...
        props.setMouseMode(WindowProperties.M_adsolute)
